...
async fn handle_signup_request(data: Cipher) -> Result<Response<Body>, Infallible> {
    ...
    // 1. Dividir o conteúdo cifrado em partes
    ...
    // 2. Decifrar e reconstruir o JSON original
